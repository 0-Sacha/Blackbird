...
#include "Event.h"
#include "OpenGlCore/Core/Input/MouseBt.h"
...
namespace OGLC {
	...
	public:
		...
		std::string ToString() const override {
			std::string str;
			CPPTools::Fmt::FormatInString(str, "MouseMoved: {}, {}", m_X, m_Y);
			return str;
		}
	...
	public:
		...
		std::string ToString() const override {
			std::string str;
			CPPTools::Fmt::FormatInString(str, "MouseScrolled: {}, {}", m_XOffset, m_YOffset);
			return str;
		}
	...
	public:
		...
		std::string ToString() const override {
			std::string str;
			CPPTools::Fmt::FormatInString(str, "MouseButtonPressed: {}", m_BtCode);
			return str;
		}
	...
	public:
		...
		std::string ToString() const override {
			std::string str;
			CPPTools::Fmt::FormatInString(str, "MouseButtonReleased: {}", m_BtCode);
			return str;
		}
