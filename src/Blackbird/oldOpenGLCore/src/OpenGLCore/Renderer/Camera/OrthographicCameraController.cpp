...
namespace OGLC::Utils {
	...
	void OrthographicCameraController::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<MouseScrolledEvent>(OGLC_BIND_EVENT(OrthographicCameraController::OnMouseScrolled));
		dispatcher.Dispatch<WindowResizeEvent>(OGLC_BIND_EVENT(OrthographicCameraController::OnWindowResized));
	}
