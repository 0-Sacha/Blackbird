...
namespace EngineCore::FMT {
	...
	struct FormatType<Spitfire::ShaderType, FormatContext>
	{
		static void Write(const Spitfire::ShaderType t, FormatContext& context) {
			switch (t)
			{
			case Spitfire::ShaderType::None:
				context.PrintCharPt("None Shader");
				break;
			case Spitfire::ShaderType::Vertex:
				context.PrintCharPt("Vertex Shader");
				break;
			case Spitfire::ShaderType::Fragment:
