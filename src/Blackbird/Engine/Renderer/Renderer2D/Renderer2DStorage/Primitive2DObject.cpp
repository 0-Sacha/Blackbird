...
namespace Blackbird::Renderer2DUtils::Primitive
{
	...
	void Primitive2DQuad::Init()
	{
		...
		std::shared_ptr<VertexBuffer> squareVertexBuffer = AssetFactory::CreateVertexBuffer(squareVertices, sizeof(squareVertices));
		...
		std::shared_ptr<IndexBuffer> squareIndexBuffer = AssetFactory::CreateIndexBuffer(squareIndices, sizeof(squareIndices) / sizeof(uint32_t));
